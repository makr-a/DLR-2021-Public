\documentclass[DIN,parskip=half,fromrule=off,fontsize=11pt,fromalign=right,fromrule=afteraddress,ngerman,enlargefirstpage=true]{scrlttr2}
...
\setkomavar{backaddress}{\parbox[c]{70mm}{\usekomavar{fromname}, \usekomavar{fromaddress}\\ Aktenzeichen XY ungelöst}}
\makeatother
